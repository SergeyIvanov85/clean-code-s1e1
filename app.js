...
var createNewTaskElement = function (taskString) {
  ...
  checkBox.className = 'incomplete-tasks__checkbox task-checkbox';
  //label
  ...
  editInput.type = 'text';
  editInput.className = 'incomplete-tasks__input task-input';

  editButton.innerText = 'Edit'; //innerText encodes special characters, HTML does not.
  editButton.className = 'incomplete-tasks__btn btn btn_edit';

  deleteButton.className = 'incomplete-tasks__btn btn btn_delete';
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains(
    'incomplete-tasks__item_edit-mode'
  );
